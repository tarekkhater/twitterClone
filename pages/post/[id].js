  ...
  return (
    <div>
      <Head>
       ...
       <div className={styles.Sidebar} id={styles.Sidebar}><Sidebar /></div> 
       <div  id={styles.Feeds}><div className="">
          <div className="">
            <div>
            </div>
       ...
       <div className={styles.Widget} id={styles.Widget}><Widget articles={News?.articles} profiles={users?.users} /></div>
